...
% Для оформления подписей
\usepackage{caption}

% Для расположения изображений рядом
...
% добавление нумерации типа число.число
\usepackage{enumitem}
...
\newcommand{\chipher}{
        {\fontsize{16pt}{16pt}\selectfont  КР.ИИ-21.210560-40 03 01}
}

\newcommand{\theme}{Разработка Telegram Mini App для автоматизации работы кафе}
