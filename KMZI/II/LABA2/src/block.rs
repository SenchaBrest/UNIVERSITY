...
fn write_hash_state_to_file(filename: &str,
                            mut h: [u32; DIGEST_BUF_LEN],
                            bb : &[u32; HALF_DIGEST_BUF_LEN],
                            bbb : &[u32; HALF_DIGEST_BUF_LEN]
...
macro_rules! process_block(
    ...
    $( par_round4: h_ordering $pf0:expr, $pf1:expr, $pf2:expr, $pf3:expr;
        ...
        if let Err(err) = write_hash_state_to_file("hash.txt", *$h, &bb, &bbb) {
            eprintln!("Error writing hash state: {:?}", err);
        }
