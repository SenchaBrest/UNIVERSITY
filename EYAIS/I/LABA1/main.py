...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.word_listbox.grid(row=2, column=0, columnspan=4, padx=5, pady=5, sticky=tk.W+tk.E+tk.N+tk.S)
        self.word_listbox.bind("<<ListboxSelect>>", self.show_word_info)

        self.word_info_text = tk.Text(self, wrap="word")
        self.word_info_text.grid(row=3, column=0, columnspan=4, padx=5, pady=5, sticky=tk.W+tk.E+tk.N+tk.S)
